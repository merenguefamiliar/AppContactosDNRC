...
@Composable
fun PantallaDetalles(navController: NavHostController, viewModel: ContactViewModel, contactoId: Int) {
    ...
    if (contacto != null) {
        Scaffold(
            ...
            Column(
                ...
                AsyncImage(model = contacto.imageUrl, contentDescription = "Foto del contacto", modifier = Modifier.size(300.dp))
                ...
                Button( onClick = { viewModel.eliminarContact(contacto)
                ...
                Button( onClick = { navController.navigate("editar/${contacto.id}") },
                    colors = ButtonDefaults.buttonColors(Color.Red))
